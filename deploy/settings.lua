--Settings
SAVE_WITHOUT_KNOWN_TIME = false -- Set to false to only save data if global (fake) timeSynced is true
...
MAX_FILES = 1000 -- Stop saving files to flash after this many are saved
